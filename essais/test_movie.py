...
m1 = Movie("Les évadés", 122, ["Drame"], 9.0)
print(vars(m1))
print(dir(m1))


m2: Movie = Movie('Les indestructibles', 115, ['Animation', 'Action', 'Aventure'], 8)
print('Tout est OK.')

try:
    m2 = Movie('Les évadés', 122, ['Animation', 'Action', 'Aventure'], -0.01)
...
try:
    m2 = Movie('Les évadés', 122, ['Animation', 'Action', 'Aventure'], 10.01)
    print('La ligne précédente aurait dû lancer une exception !!?')
except ValueError as e:
    print(f"L’exception \"{e}\" a bien été lancée.")
except:
